...
class Tutnew extends StatefulWidget {
  const Tutnew({super.key});

  @override
  State<Tutnew> createState() => _TutnewState();
}

class _TutnewState extends State<Tutnew> {
 ...
 int flag = 0;
  ...
  Future<dynamic> tutnew() async {
    var response = await get(
      Uri.parse('${Con.url}/viewTutnew.php'),
    );
    print(response.body);
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: FutureBuilder(future: tutnew(),

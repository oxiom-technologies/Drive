...
class StudOLD extends StatefulWidget {
  const StudOLD({super.key});

  @override
  State<StudOLD> createState() => _StudOLDState();
}

class _StudOLDState extends State<StudOLD> {
 ...
 int flag = 0;
  ...
  Future<dynamic> Stud() async {
    var response = await get(
      Uri.parse('${Con.url}/viewStudOld.php'),
    );
    print(response.body);
